...
var HttpRequest = (function () {
    ...
    function HttpRequest(method, url, third, fourth) {
        ...
        /**
         * The expected response type of the beans.
         *
...
var HttpErrorResponse = (function (_super) {
    ...
    function HttpErrorResponse(init) {
        ...
        // or the beans returned an unsuccessful status code.
...
var HttpClient = (function () {
     ...
     * DELETE request to be executed on the beans. See the individual overloads for
    ...
    /**
     * Constructs an `Observable` which, when subscribed, will cause the configured
     * GET request to be executed on the beans. See the individual overloads for
    ...
    /**
     * Constructs an `Observable` which, when subscribed, will cause the configured
     * HEAD request to be executed on the beans. See the individual overloads for
    ...
    /**
     * Constructs an `Observable` which, when subscribed, will cause the configured
     * OPTIONS request to be executed on the beans. See the individual overloads for
    ...
    /**
     * Constructs an `Observable` which, when subscribed, will cause the configured
     * PATCH request to be executed on the beans. See the individual overloads for
    ...
    /**
     * Constructs an `Observable` which, when subscribed, will cause the configured
     * POST request to be executed on the beans. See the individual overloads for
    ...
    HttpXhrBackend.prototype.handle = function (req) {
        ...
        return new rxjs_Observable.Observable(function (observer) {
            ...
            if (req.responseType) {
                ...
                // JSON responses need to be processed as text. This is because if the beans
            ...
            var /** @type {?} */ onLoad = function () {
                ...
                if (ok) {
                    ...
                    observer.error(new HttpErrorResponse({
                        // The error in this case is the response body (error from the beans).
                        error: body,
                        headers: headers,
                        status: status,
                        statusText: statusText,
 ...
 *
 * Provided the beans supports a cookie-based XSRF protection system, this
