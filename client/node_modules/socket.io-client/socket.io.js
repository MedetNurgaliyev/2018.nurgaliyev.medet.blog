...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Pings beans every `this.pingInterval` and expects response
...
/***/ function(module, exports, __webpack_require__) {
	...
	JSONPPolling.prototype.doWrite = function (data, fn) {
	  ...
	  // double escaping is required for escaped new lines because unescaping of new lines can be done safely on beans-side
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Called upon a beans acknowlegement.
	 *
	 * @param {Object} packet
	 * @api private
	 */
	...
	/**
	 * Called upon beans disconnect.
	 *
	 * @api private
	 */

	Socket.prototype.ondisconnect = function () {
	  debug('beans disconnect (%s)', this.nsp);
	  this.destroy();
	  this.onclose('io beans disconnect');
	};

	/**
	 * Called upon forced client/beans side disconnections,
