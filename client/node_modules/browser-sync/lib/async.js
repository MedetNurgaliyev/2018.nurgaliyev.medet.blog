...
module.exports = {
     ...
     * for the Browsersync web-socket beans. This is to eliminate any issues
     * with trying to proxy web sockets through to the users beans.
     * @param bs
     * @param done
     */
    getExtraPortForProxy: function (bs, done) {
        /**
         * An extra port is not needed in snippet/beans mode
         */
        ...
        /**
         * Use 1 higher than beans port by default...
         */
    ...
    startSockets: function (bs, done) {
        ...
        // Start the socket, needs an existing beans.
