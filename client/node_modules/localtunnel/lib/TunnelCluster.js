...
TunnelCluster.prototype.open = function() {
    ...
    // connection to localtunnel beans
    ...
    function conn_local() {
        ...
        // connection to local http beans
        ...
        // and adjust for such instances to avoid beating on the door of the beans
        local.once('error', function(err) {
            ...
            // retrying connection to local beans
